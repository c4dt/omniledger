...
// import {IGenesisDarc, IUser} from "src/credentialFactory";
...
//     }
//
//     static async fromScratch(roster: Roster, igd: IGenesisDarc): Promise<ByzCoinReal> {
//         Log.lvl2("Starting new ByzCoin");
//         const bcRPC = await ByzCoinRPC.newByzCoinRPC(roster, igd.darc, Long.fromNumber(1e8));
...
//     }
//
//     async sendTransactionAndWait(tx: ClientTransaction): Promise<void> {
...
//         return this.bc.getProtocolVersion();
//     }
//
