...
We suppose that you want to use it on the official DEDIS 9cc3-chain, and that you already have an account.
Then you will have to do the following:

1. Initialize the ByzCoinRPC and the IStorage class
2. 
