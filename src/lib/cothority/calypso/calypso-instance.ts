...
import Instance from '../byzcoin/instance';
import {createHash} from 'crypto';
import {Log} from '../../Log';
import CoinInstance from '../byzcoin/contracts/coin-instance';
import {Coin} from '../byzcoin/contracts/coin-instance';
import Keccak from 'keccak';
import {randomBytes} from 'crypto';
import {Point, curve, Scalar} from '@dedis/kyber';
import {CredentialStruct} from '../byzcoin/contracts/credentials-instance';
...
export class CalypsoReadInstance extends Instance{
  ...
  static async spawn(bc: ByzCoinRPC, writeId: InstanceID, pub: Point, signers: Signer[]) {
    ...
    return CalypsoReadInstance.fromByzcoin(bc, ctx.instructions[0].deriveId());
  }
